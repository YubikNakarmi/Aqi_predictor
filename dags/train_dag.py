...
with DAG(dag_id="aqi_train_dag",
    ...
    preprocess = DockerOperator(
        ...
        mounts=mounts,
        command = "python hourly_train_pipeline/preprocess.py",
    ...
    tune = DockerOperator(
        ...
        api_version='auto',
        auto_remove='success',
        command='python hourly_train_pipeline/tune.py',
        docker_url='unix://var/run/docker.sock',
        network_mode='pypipeline_aqi_network',
        mounts=mounts,
    ...
    train = DockerOperator(
        ...
        api_version='auto',
        auto_remove='success',
        command='python hourly_train_pipeline/train.py',
        docker_url='unix://var/run/docker.sock',
        network_mode='pypipeline_aqi_network',
        mounts=mounts,
        environment=shared_env,
    ...
    eval = DockerOperator(
        ...
        api_version='auto',
        auto_remove='success',
        command='python hourly_train_pipeline/eval.py',
        environment=shared_env,
        docker_url='unix://var/run/docker.sock',
        network_mode='pypipeline_aqi_network',
        mounts=mounts,
